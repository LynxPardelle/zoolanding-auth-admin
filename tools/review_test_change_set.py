...
def review_change_set(
    ...
    *,
    ...
    if (
        ...
        # DescribeChangeSet has no ChangeSetType response field. The type is
        # bound to the create request by the runner; reject contradictory data
        # if a recorded/enriched response supplies it.
